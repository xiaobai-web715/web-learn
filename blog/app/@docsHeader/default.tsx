...
function DocsHeader() {
    ...
    useEffect(() => {
        ...
        const apply = () => {
            ...
            setCurrentIcon(isDark ? 'dark' : 'light');
        };
        apply();
        ...
        <Fragment>
            <div className="DocsHeader pl-[0.5rem] pr-[0.5rem] md:pl-[1rem] md:pr-[1rem] md:h-[4rem] h-[3rem]">
                ...
                <div className="md:w-[40%] w-[45%] header-middle border-[2px] border-rose-500/10 rounded-[1.6rem] h-[66.6%] flex shrink-1 items-center pl-[1rem]">
                    ...
                    <input
                        className="inline-block flex-1 min-w-0 outline-none shadow-none pl-[0.5rem] pr-[0.5rem] h-[80%] md:h-[100%]"
                        type="text"
                    ></input>
                    <div className="shrink-0 grow-0 text-responsive cursor-pointer h-[100%] pl-[1rem] pr-[1rem] rounded-[1.6rem] flex items-center justify-center background-line-gradient">
                        搜索
                    </div>
                </div>
                <div className="header-right flex items-center justify-between text-responsive ml-[0.5rem]">
                    ...
                    <div className="theme-icon cursor-pointer ml-[0.5rem]" onClick={changeTheme}>
                        {currentIcon === 'light' ? (
                            ...
                            <FaRegMoon className="w-[1rem] h-[1rem] md:w-[1.5rem] md:h-[1.5rem]" />
                        )}
                    </div>
                </div>
            </div>
