                        ...
                        return (
                            <div key={index} className="flex-1">
                                <div className="group cursor-pointer pl-16 pr-16">
                                    <div
                                        className="relative m-auto h-[180px] w-[180px] transition-transform duration-300 ease-linear group-hover:translate-y-[-10px]"
                                        onClick={() => gotoInterPage(item.tag)}
                                    >
                                        <div className="box-shadow-[0_0_60px_4px_rgba(0,0,0,0.5)] absolute inset-0 rotate-45 transform rounded-lg border-8 border-gray-700 shadow-lg group-hover:border-red-600"></div>
                                        <div className="overflow-inherit absolute inset-0 transform rounded-lg border-gray-800">
                                            <div
